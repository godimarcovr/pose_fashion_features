function alphaposeresults = read_json_text_fn(filename, startRow, endRow)
%read_json_text_fn Import numeric data from a text file as a matrix.
%   ALPHAPOSERESULTS = IMPORTFILE(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   ALPHAPOSERESULTS = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data
%   from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   alphaposeresults = read_json_text_fn('alpha-pose-results.json', 1, 1);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/02/21 15:10:29
